...
PKG_DEPENDS_TARGET="toolchain jansson libexif libwebsockets2 vdr-tinyxml vdr"
PKG_NEED_UNPACK="$(get_pkg_directory vdr)"
PKG_LONGDESC="Allows a comfortable operation of VDR trough a web interface."
PKG_BUILD_FLAGS="-gold"

pre_configure_target() {
#  CFLAGS+="-I${SYSROOT_PREFIX}/usr/include -I$(get_build_dir jansson)/.$TARGET_NAME/include -I$(get_build_dir libwebsockets2)/.$TARGET_NAME/include"
  CFLAGS+="-I$(get_build_dir jansson)/.$TARGET_NAME/include -I$(get_build_dir libwebsockets2)/.$TARGET_NAME/include"
}
