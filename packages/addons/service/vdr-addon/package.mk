...
PKG_DEPENDS_TARGET="toolchain vdr vdr-plugin-ddci2 vdr-plugin-dummydevice vdr-plugin-dvbapi vdr-plugin-eepg vdr-plugin-epgfixer \
                    vdr-plugin-epgsearch vdr-plugin-iptv vdr-plugin-restfulapi vdr-plugin-robotv vdr-plugin-satip \
...
addon() {
  ...
  cp -P $(get_build_dir vdr-plugin-osd2web)/*.conf $ADDON_BUILD/$PKG_ADDON_ID/config/plugins/osd2web
  ...
  # copy binaries
  for pkg in ddci2 dummydevice dvbapi eepg epgfixer epgsearch iptv restfulapi robotv satip vnsiserver wirbelscan wirbelscancontrol xmltv2vdr; do
